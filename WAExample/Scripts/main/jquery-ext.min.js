...
!function(e){e.extend(e.expr[":"],{scrollable:function(t){var l,i;return"scroll"==e(t).css("overflow")||"scroll"==e(t).css("overflowX")||"scroll"==e(t).css("overflowY")?!0:(l=t.clientHeight<t.scrollHeight&&(-1!=e.inArray(e(t).css("overflowY"),["scroll","auto"])||-1!=e.inArray(e(t).css("overflow"),["scroll","auto"])))?!0:i=t.clientWidth<t.scrollWidth&&(-1!=e.inArray(e(t).css("overflowX"),["scroll","auto"])||-1!=e.inArray(e(t).css("overflow"),["scroll","auto"]))}})}(jQuery),!function(e){e.fn.skinner=function(t){var l={type:"block",minWidth:"",width:"auto",textwrap:!1,maxitem:"6",itemMinWidth:"",mode:"select",placeHolder:"please select",valueNullable:!1,disabled:!1,dropdownList:{hideMode:"auto"}};void 0!==t&&e.extend(l,t);var i=this;l.disabled=e(i).prop("disabled");var s={$:{select:null,container:null,controller:null,acceptor:null}};return s=e.extend(s,{_li_click:function(t,n){var o=this,c=s.$.acceptor;c.hide(),e(i).triggerHandler("whenClickItem",[t,o,n]);var r=s.$.controller.children(".select-skinned-cont").html(),d="",a=s.$.select,h=a.find("option"),u=h.eq(t),p=h.eq(0);r="&nbsp;"===r?"":r,"multiple"!==l.multiple&&(r!==u.text()?(h.removeAttr("selected"),u.attr("selected","selected"),d=u.text(),s.$.controller.html('<div class="select-skinned-cont" title="'+d+'">'+d+"</div>"),o.addClass("select-skinned-li-selected"),c.nextAll("select:first").change()):!0===l.valueNullable?(u.removeAttr("selected"),p.attr("selected","selected"),d=p.html()||l.placeHolder||"&nbsp;",s.$.controller.html('<div class="select-skinned-cont" title="'+d+'">'+d+"</div>"),o.removeClass("select-skinned-li-selected"),c.nextAll("select:first").change()):c.nextAll("select:first").trigger("unchange"))},_init_li:function(t){var n=e(t),o=s.$.acceptor;o.html(""),n.children("option").each(function(t,c){var r=e(c),d=""===r.html()?"&nbsp;":r.html();if(0===t){if(!0===l.valueNullable)return;0===n.children("option[selected]").size()&&r.attr("selected","selected")}var a=e("<li>"+d+"</li>").click(function(){return e(i).triggerHandler("beforeClickItem",[t,a,n])}).click(function(l){!1===l.result||(s._li_click.call(a,t,n),e(i).triggerHandler("afterClickItem",[t,a,n]))});!0===r.prop("selected")&&a.addClass("select-skinned-li-selected"),o.append(a)})},_apply_max_item:function(){var t=e(this),i=t.children("li"),s=l.maxitem;if(void 0!==s&&!1!==s){for(var n=0,o=s;o-->0;)n+=i.eq(o).outerHeight();s=l.maxitem,t.css({"overflow-y":"scroll",height:n+"px"})}}}),s=e.extend(s,{selectskinned:function(t){var i=e(t);s.$.select=i,i.wrap('<div class="select-skinned" />'),s.$.container=i.parent();var n=e('<ul style="display:none;"></ul>');s.$.acceptor=n,i.parent().on("mouseleave",function(){("auto"===l.dropdownList.hideMode||"leave"===l.dropdownList.hideMode)&&n.hide()}),!0===l.valueNullable?0===i.children("option[selected]").size()&&i.children("option").eq(0).attr("selected","selected"):0===i.children("option[selected]").size()&&i.children("option").eq(0).attr("selected","selected");var o=i.children("option[selected]"),c=o.size()<=0?l.placeHolder:""===o.text()?"&nbsp;":o.text(),r=e('<div class="select-skinned-text"><div class="select-skinned-cont" title="'+c+'">'+c+"</div></div>");s.$.controller=r,r.click(function(){var t=e(this),i=t.nextAll("ul:first"),n=s.$.container.offset(),o=s.$.container.parent(":scrollable"),c=0,r=0;0===o.size()?o=e(window):(c=o.offset().top,r=o.offset().left);var d=o.scrollTop();i.css(i.outerHeight()+15<n.top-d&&o.height()+c<=n.top+i.outerHeight()+15-d?{top:"auto",bottom:"0"}:{top:t.prev(".select-skinned-text").children(".select-skinned-cont").height(),bottom:"auto"}),i.css(o.width()+r<=n.left+i.outerWidth()?{left:"auto",right:"0"}:{left:"0",right:"auto"}),i.is(":visible")?i.hide():(l.disabled=e(this).siblings("select:first").prop("disabled"),!0===l.disabled?i.hide():i.show()),s._apply_max_item.call(i.get(0))}),i.before(r),i.before(n),i.change(function(){s._init_li(t),s.addStyle()}),i.hide(),s._init_li(t),s.addStyle()},resetSelect:function(t){if(0!==e(t).prev("ul").size()){var l=e(t).find("option").eq(0).text();e(t).prev("ul").prev(".select-skinned-text").html('<div class="select-skinned-cont" title="'+l+'">'+l+"</div>")}},addStyle:function(){var t=e(i),n=s.$.container,o=n.children("ul").children("li");if("auto"===l.width&&(l.width=t.width()),n.css("min-width",l.minWidth||l.width).width(l.width).children("ul").css("min-width",l.itemMinWidth||l.width),n.css({height:s.$.controller.height()}),!0===l.textwrap&&o.css({"white-space":"normal"}),o.hover(function(){e(this).addClass("hover")},function(){e(this).removeClass("hover")}),s.$.controller.hover(function(){l.disabled=e(this).siblings("select:first").prop("disabled")},function(){}),"puretext"===l.mode.toLowerCase()){var c="select-skinned-pure-text";s.$.controller.addClass(c).hover(function(){l.disabled=e(this).siblings("select:first").prop("disabled"),!1===l.disabled&&e(this).removeClass(c)},function(){!1===l.disabled&&e(this).addClass(c)})}"block"!==l.type&&n.css({"float":l.type})}}),e(i).parent().is(".select-skinned")||s.selectskinned(i),this}}(jQuery);
